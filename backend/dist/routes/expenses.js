...
const financialTimelineController_1 = require("../controllers/financialTimelineController");
...
router.patch('/:id/active-status', (0, entityActiveStatus_1.createEntityActiveStatusHandler)('expenses'));
router.get('/:id/timeline', financialTimelineController_1.getExpenseTimeline);
