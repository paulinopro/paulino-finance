...
router.patch('/:id/active-status', (0, entityActiveStatus_1.createEntityActiveStatusHandler)('income'));
router.get('/:id/timeline', financialTimelineController_1.getIncomeTimeline);
