 ...
 */
const getMonthlyInterestRate = (interestRate, interestRateType) => {
 ...
 */
const calculateEffectiveAnnualRate = (nominalAnnualRate) => {
...
exports.calculateEffectiveAnnualRate = calculateEffectiveAnnualRate;
/**
 ...
 */
const calculateDaysForBase = (fromDate, toDate, base) => {
...
const generateAmortizationSchedule = async (loanId, userId) => {
    ...
    let disbursementPaymentId = undefined;
 ...
 */
const calculateAccruedInterest = (principal, interestRate, interestRateType, fromDate, toDate, interestCalculationBase = 'ACTUAL_360') => {
    // Get annual interest rate (convert to decimal)
...
const processPayment = async (loanId, paymentDate, amountPaid, paymentType = 'COMPLETE', installmentNumber) => {
    ...
    const accruedInterest = (0, exports.calculateAccruedInterest)(currentBalance, loan.interestRate, loan.interestRateType, lastPaymentDate, paymentDateObj, loan.interestCalculationBase);
    ...
    if (expectedPayment) {
        ...
        if (daysLate > 0 && paymentDateObj > dueDate) {
            ...
            lateFee = Math.min(currentBalance * lateFeeRate * daysLate, loan.installmentAmount * 0.05);
        }
...
exports.saveAmortizationSchedule = saveAmortizationSchedule;
