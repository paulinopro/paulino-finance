...
async function removeExpenseForUser(userId, expenseId) {
    const pre = await (0, database_1.query)(`SELECT recurrence_type, frequency, bank_account_id, amount, currency, description FROM expenses WHERE id = $1 AND user_id = $2`, [expenseId, userId]);
