...
exports.parseFirstVEvent = parseFirstVEvent;
...
function parseFirstVEvent(raw) {
    ...
    for (const line of lines.slice(start + 1, end)) {
        ...
        if (!fields.has(parsed.name))
            fields.set(parsed.name, { params: parsed.params, value: parsed.value });
    }
...
//# sourceMappingURL=agendaIcsParser.js.map