...
exports.deleteAccountReceivable = exports.receiveAccountReceivable = exports.updateAccountReceivable = exports.createAccountReceivable = exports.getAccountsReceivable = void 0;
...
const receiveAccountReceivable = async (req, res) => {
    try {
       ...
       RETURNING id, description, amount, currency, due_date, status, category, notes, received_date, created_at, updated_at`, [receivedDate || new Date().toISOString().split('T')[0], notes, id, userId]);
        // Add to income as variable income
        await (0, database_1.query)(`INSERT INTO income (user_id, description, amount, currency, income_type, date)
