...
const deleteSubscriptionPlan = async (req, res) => {
    try {
        ...
        const inUse = await (0, database_1.query)(`SELECT COUNT(*)::int AS c FROM user_subscriptions WHERE plan_id = $1`, [id]);
...
//# sourceMappingURL=adminSubscriptionPlansController.js.map